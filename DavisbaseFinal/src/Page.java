...
//a class to implement B trees in an index file and B+ trees in a table file
public class Page<T> {
    ...
    /*
      Each field identifies the page type
    ...
    /*
     Each field identifies the number of cells in the page.
     */
